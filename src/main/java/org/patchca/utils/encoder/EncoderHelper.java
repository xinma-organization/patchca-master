...
import org.patchca.service.CustomCaptchaService;
...
public class EncoderHelper {
	...
	public static String getRandomAndWriteImage(CustomCaptchaService service, String format, OutputStream os) throws IOException {
		service.randomColorAndFilter();
		return getChallangeAndWriteImage(service, format, os);
	}
}
